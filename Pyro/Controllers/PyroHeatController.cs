...
{
    public class PyroHeatController : NetworkBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (heatPercent > 0f)
            {
                ...
                {
                    heatPercent -= Time.fixedDeltaTime / PyroHeatController.baseHeatDecayDuration;
                    if (heatPercent < 0f)
                    {
                        heatPercent = 0f;
                        gaugeEnabled = false;
            ...
            if (skillLocator.secondary.skillDef.skillName == "FireBlast")
            {
                if (heatPercent < Skills.HeatWave.heatCost)
                {
        ...
        public static Texture2D heatGauge;
        public static Texture2D heatGauge_Heated;
        public static Texture2D heatBar;
        public static Texture2D heatBar_Heated;
